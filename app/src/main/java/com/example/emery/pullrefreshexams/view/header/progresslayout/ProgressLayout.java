package com.example.emery.pullrefreshexams.view.header.progresslayout;
...
import com.example.emery.pullrefreshexams.view.IHeaderView;
import com.example.emery.pullrefreshexams.view.OnAnimEndListener;
...
public class ProgressLayout extends FrameLayout implements IHeaderView {
    ...
    private CircleImageCView mCircleView;
    ...
    private void createProgressView() {
        mCircleView = new CircleImageCView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
